...
function ch1Linear() {
  ...
  for (let i = 0; i < aliceWordsCh1.length; i++) {
    let found = linearSearch(dictionary, aliceWordsCh1[i].toLowerCase());
    if (found < 0) {
      console.log(aliceWordsCh1[i] + " is not found in the dictionary");
      total++;
    }
  }
  document.getElementById("ch1-result").innerHTML = total + " words are NOT found in the dictionary";
  // **********************************
}
...
function ch1Binary() {
  ...
  let total = 0;
  for (let i = 0; i < aliceWordsCh1.length; i++) {
    let found = binarySearch(dictionary, aliceWordsCh1[i].toLowerCase());
    if(found < 0) {
      console.log(aliceWordsCh1[i] + " is NOT found in the dictionary");
      total++;
    }
...
function fullLinear() {
  ...
  for (let i = 0; i < aliceWordsFull.length; i++) {
    let found = linearSearch(dictionary, aliceWordsFull[i].toLowerCase());
    if (found < 0) {
      console.log(aliceWordsFull[i] + " is NOT in the dictionary");
      total++
    }
  }
  document.getElementById("full-result").innerHTML = total + " words are NOT found in the dictionary";
  // **********************************
}
...
function fullBinary() {
  ...
  let total = 0;
  for (let i = 0; i < aliceWordsFull.length; i++) {
    let found = binarySearch(dictionary, aliceWordsFull[i].toLowerCase());
    if (found < 0) {
      console.log(aliceWordsFull[i] + " is NOT in the dictionary");
      total++;
    }
